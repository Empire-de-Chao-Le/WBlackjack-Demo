    ...
    <>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 py-2">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-border bg-[#faf7ff] dark:bg-[#181322] hover:bg-muted/60 hover:border-primary/40 transition-all p-6 aspect-square shadow-sm active:scale-95 pl-[12px] pr-[12px] pt-[0px] pb-[0px]"
        >
